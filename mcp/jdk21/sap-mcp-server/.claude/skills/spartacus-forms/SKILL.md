---
name: spartacus-forms
description: |
  Review or generate SAP Spartacus 6.x reactive forms with validation, error display,
  and checkout form customization.
  Covers FormBuilder, CustomFormValidators, cx-form-errors, and form accessibility.
  Auto-triggers on Spartacus form components, CustomFormValidators, cx-form-errors.
  Also trigger with: "spartacus form", "checkout form", "reactive form spartacus",
  "form validation", "FormValidators", "form component".
argument-hint: "review|generate [FormName]"
