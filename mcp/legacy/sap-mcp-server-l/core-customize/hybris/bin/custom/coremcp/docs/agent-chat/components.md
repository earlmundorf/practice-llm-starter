...
| `DefaultLlmClient.java` | `src/com/coremcp/services/impl/` | Routes to the configured provider based on `coremcp.llm.provider` (default `openai`; production default `anthropic`). See `coremcp/docs/reference/llm-providers.md`. |
