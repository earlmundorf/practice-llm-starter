...
name: spartacus-occ
description: |
  Review or generate SAP Spartacus 6.x OCC adapter customizations.
  Covers custom OCC adapters, endpoint configuration, converters,
  normalizers, serializers, interceptors, and ConverterService usage.
  Auto-triggers on OCC adapter, converter, normalizer, or endpoint config code.
  Also trigger with: "OCC adapter", "converter", "normalizer", "serializer",
  "OCC endpoint", "OccEndpointsService", "ConverterService", "occ config".
argument-hint: "review|generate [AdapterName]"
