---
name: spartacus-component
description: |
  Review or generate SAP Spartacus 6.x CMS components following NgModule patterns.
  Covers CMS component mapping, CmsComponentData injection, feature modules,
  lazy loading, outlets, slots, and smart/presentational component splits.
  Auto-triggers on Spartacus component, feature module, or CMS mapping code.
  Also trigger with: "spartacus component", "CMS component", "feature module",
  "component mapping", "cmsComponents", "CmsComponentData".
