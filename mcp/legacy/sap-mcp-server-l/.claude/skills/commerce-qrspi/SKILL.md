...
- **End of a ticket (stage 7):** summarize new findings and propose which to **promote**
  into the stage commands, this SKILL.md, the verb config, or the repo's CLAUDE.md.
...
`cp .claude/skills/commerce-qrspi/commands/*.md .claude/commands/cq/`. Drift means `/cq`
