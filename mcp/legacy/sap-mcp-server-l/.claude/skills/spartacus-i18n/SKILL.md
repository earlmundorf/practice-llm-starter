...
name: spartacus-i18n
description: |
  Review or generate SAP Spartacus 6.x internationalization: translation chunks, cxTranslate pipe,
  key namespacing, ICU pluralization, and locale-aware formatting.
  Auto-triggers on cxTranslate, i18n config, translation chunk files, I18nModule.
  Also trigger with: "spartacus i18n", "translation", "cxTranslate",
  "translation chunk", "i18n config", "localization".
argument-hint: "review|generate [ChunkName]"
