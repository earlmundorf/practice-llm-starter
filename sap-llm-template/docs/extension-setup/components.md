...
Defines custom item types, attributes, relations, and enums. When types are added here, `ant clean all` regenerates Model classes in `gensrc/`.
...
`ant build` generates the Java classes.
